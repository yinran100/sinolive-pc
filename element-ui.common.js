...
exports.default = {
  ...
  render: function render(h) {
    ...
    if(!sums.col) sums= {col:sums}
    if(!sums.col instanceof Array ) throw Error(` propotype 'col' in  result of Function 'summaryMethod' must be a Array`); 
